...
import pytest
from flight_scanner.date_utils import (get_travel_dates, convert_date_format,
                                       format_datetime_to_textdate_and_time, get_flight_date)


def get_weekday_index(day):
    """
    Returns the index of the given day in the week.
    """
...
def mock_get_weekday_index(monkeypatch):
    """
    Patches 'get_weekday_index' in 'flight_scanner.date_utils'.
    """
    monkeypatch.setattr('flight_scanner.date_utils.get_weekday_index', get_weekday_index)


@freeze_time("2024-05-20")
def test_get_travel_dates_one_month():
    """
    Tests 'get_travel_dates' for one month from Monday to Friday.
    """
    start_day = 'Monday'
    end_day = 'Friday'
...
def test_format_datetime_to_textdate_and_time():
    """
    Tests 'format_datetime_to_textdate_and_time' formatting.
    """
...
def test_convert_date_format_single_digit_day():
    """
    Tests 'convert_date_format' for single-digit days.
    """
...
def test_convert_date_format_double_digit_day():
    """
    Tests 'convert_date_format' for double-digit days.
    """
...
def test_get_flight_date():
    """
    Tests 'get_flight_date' extraction and conversion.
    """
